...
# the OOD /rnode Apache proxy holds SSE connections open and corrupts concurrent
# sibling requests (a status poll returns the buffered SSE body). Plain GETs are
